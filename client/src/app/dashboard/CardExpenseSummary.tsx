      ...
      {isLoading ? (
        ...
        <>
          <div className="flex flex-col justify-between bg-white shadow-md rounded-2xl h-112 xl:h-80 md:h-105">
            ...
            {/* BODY */}
            <div className="flex flex-col xl:flex-row justify-between px-7 py-5 flex-1">
              {/* CHART */}
              ...
              {/* LABELS */}
              <ul className="flex flex-col justify-around items-center xl:items-start py-5 gap-3 basis-2/5">
                {expenseCategories.map((entry, index) => (
                  <li
                    key={`legend-${index}`}
